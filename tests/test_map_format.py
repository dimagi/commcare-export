...
def test_parse_template_no_args():
    expected = Apply(
...
def test_parse_template_args_long():
    expected = Apply(
        Reference('template'),
...
def test_parse_template_no_template():
    expected = Literal(
...
def test_parse_function_arg_with_brackets():
...
def test_parse_function_arg_empty_returns():
